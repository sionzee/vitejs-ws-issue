...
export declare function compileCss(root: string, publicPath: string, { source, filename, scoped, modules, preprocessLang, preprocessOptions }: SFCAsyncStyleCompileOptions, isBuild?: boolean): Promise<SFCStyleCompileResults | string>;
